...
<%
	...
	System.out.println("returnForm conn: " + conn);
	
	String sql = "SELECT i.inventory_id inventoryId, i.film_id filmId, f.title title, i.store_id storeId"
...
<body>
	...
	<%
		if(rs.next()) {
	%>
		<form action="/sakila/d0401/returnCustomerList.jsp" method="post">
			<input type="hidden" name="inventoryId" value="<%=inventoryId%>">
			<input type="text" name="searchName">
			<button type="submit">이름으로 customerId 검색</button>
		</form>
		
		<form action="/sakila/d0401/returnAction.jsp" method="post">
			<table border="1">
				<tr>
					<td>customerId</td>
					<td>
				...
				<tr>
					<td>storeId</td>
					<td>
						<input type="text" name="storeId" value="<%=rs.getInt("storeId")%>" readonly>
					</td>
				</tr>
				<tr>
					<td>staffId</td>
