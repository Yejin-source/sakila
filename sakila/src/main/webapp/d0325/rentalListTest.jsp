...
<body>
	...
	<a href="/sakila/d0325/rentalListTest.jsp?currentPage=1">[처음]</a>
	
	<%
		if(startPage > 1) {
	%>
			<a href="/sakila/d0325/rentalListTest.jsp?storeId=<%=storeId%>&searchWord=<%=searchWord%>&currentPage=<%=startPage-10%>">[이전 10페이지]</a>
	<%
		}
	%>
	...
	<%
		if(currentPage > 1) {
	%>
			<a href="/sakila/d0325/rentalListTest.jsp?storeId=<%=storeId%>&searchWord=<%=searchWord%>&currentPage=<%=currentPage-1%>">[이전]</a>
	<%
		}
	%>
	...
	%>
				<a href="/sakila/d0325/rentalListTest.jsp?storeId=<%=storeId%>&searchWord=<%=searchWord%>&currentPage=<%=i%>"><%=i%></a>
	<%		
			}
		}
	%>
	...
	%>
			<a href="/sakila/d0325/rentalListTest.jsp?storeId=<%=storeId%>&searchWord=<%=searchWord%>&currentPage=<%=currentPage+1%>">[다음]</a>
	<%
		}
	%>
	...
	<a href="/sakila/d0325/rentalListTest.jsp?storeId=<%=storeId%>&searchWord=<%=searchWord%>&currentPage=<%=lastPage%>">[마지막]</a>
	
	
	<form action="/sakila/d0325/rentalListTest.jsp">
